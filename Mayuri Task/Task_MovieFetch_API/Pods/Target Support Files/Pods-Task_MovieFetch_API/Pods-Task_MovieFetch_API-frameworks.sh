...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AppwiseCore/AppwiseCore.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PaginationTracker/PaginationTracker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StatefulUI/StatefulUI.framework"
